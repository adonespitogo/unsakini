...
#   describe "GET /api_board_post_comment" do
#     it "returns http unauthorized" do
#       get api_board_post_comment_path(@board, @post, @comment), as: :json, params: valid_attributes
#       expect(response).to have_http_status(:unauthorized)
#     end
#     it "returns http unauthorized" do
#       get api_board_post_comment_path(@board, @post, @comment), headers: auth_headers(@other_user), as: :json, params: valid_attributes
#       expect(response).to have_http_status(:unauthorized)
#     end
#     it "returns http unauthorized" do
#       get api_board_post_comment_path(@other_board, @other_post, @other_comment), headers: auth_headers(@user), as: :json, params: valid_attributes
#       expect(response).to have_http_status(:unauthorized)
#     end
#     it "returns http unauthorized" do
#       get api_board_post_comment_path(@board, @other_post, @other_comment), headers: auth_headers(@user), as: :json, params: valid_attributes
#       expect(response).to have_http_status(:unauthorized)
#     end
#     it "returns http unprocessable_entity" do
#       get api_board_post_comment_path(@board, @post, @other_comment), headers: auth_headers(@user), as: :json, params: invalid_attributes
#       expect(response).to have_http_status(:unprocessable_entity)
#     end
#     it "creates a new comment" do
#       comment_count = @post.comments.count
#       get api_board_post_comment_path(@board, @post), headers: auth_headers(@user), as: :json, params: valid_attributes
#       expect(response).to have_http_status(:ok)
#       expect(body_as_hash).to match(model_as_hash(@post.comments.last))
#       expect(@post.comments.count).to eq(comment_count+1)
#     end
