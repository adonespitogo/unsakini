...
module.exports = (app) ->
  ...
  app.get '/lists/:id', Auth, AC.is_list_owner, controllers.list_controller.show
  app.put '/lists/:id', Auth, AC.is_list_owner, controllers.list_controller.update
  app.delete '/lists/:id', Auth, AC.is_list_owner, controllers.list_controller.destroy

  app.get '/lists/:id/items', Auth, AC.is_list_owner, controllers.item_controller.index
  app.get '/items/:id', Auth, AC.is_item_owner, controllers.item_controller.show
  app.post '/items', Auth, controllers.item_controller.create
  app.put '/items/:id', Auth, AC.is_item_owner, controllers.item_controller.update
  app.delete '/items/:id', Auth, AC.is_item_owner, controllers.item_controller.destroy
